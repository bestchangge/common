...
import com.sun.baselibrary.BuildConfig;
import com.sun.baselibrary.util.CheckNetwork;
...
//                Log.e("sun", "------------得到的 cookies:" + d.toString());
                ...
                if (!TextUtils.isEmpty(d.toString())) {
                    ...
                    editorConfig.apply();
//                    Log.e("sun", "------------处理后的 cookies:" + stringBuilder.toString());
                }
            }
